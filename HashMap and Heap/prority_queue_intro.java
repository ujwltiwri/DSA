...
class prority_queue_intro {
    ...
    public static void solve(int n, int[] arr, int k) {
        ...
        PriorityQueue<Integer> pq = new PriorityQueue<>(); // This is Normal Priority Queue -> Elements Are Added &
                                                           // Removed in Normal Order i.e. Increasing
        // PriorityQueue<Integer> pq = new PriorityQueue<>(Collections.reverseOrder());
        // //Here Elements Are Added & Removed in Reverse Order i.e. Decreasing
